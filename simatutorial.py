...
tiff_filenames = [
    ['C:/Users/Brendan/Dropbox/BrendanShared/in vivo vision/6-25-2015/2P-{n1}--800--800.tif'.format(n1=cycle,n2=cycle)
...
segmentation_approach = sima.segment.STICA(channel=SIGNAL_CHANNEL, mu=0.25, verbose=True)
segmentation_approach.append(sima.segment.SparseROIsFromMasks(min_size=50))
segmentation_approach.append(sima.segment.SmoothROIBoundaries())
segmentation_approach.append(sima.segment.MergeOverlapping(threshold=0.2))
'''
